...
#+ Editado:	2022/02/15 20:42:19.215315
#------------------------------------------------------------------------------------------------
...
class Proxy:
    __verbose: bool
    __ligazon_ssl_proxies: str
    __sesion: None
    __proxy_list: List[dict]
    __proxy_list_gardada: List[dict]
    __proxy: dict
    __conexions: int
    __conexions_espido: int
    __max_conexions: int

    # constructor
    def __init__(self, verbose=False, max_cons=20) -> None:
