...
# + Revised:	2026/03/16 14:35:07.194823
# ------------------------------------------------------------------------------
...
class Country(str, Enum):
    ...
    Each member's string value is its two-letter code.
    The ``country_name`` attribute holds the full English name.
    ...
    def __new__(cls, code: str, country_name: str) -> "Country":
